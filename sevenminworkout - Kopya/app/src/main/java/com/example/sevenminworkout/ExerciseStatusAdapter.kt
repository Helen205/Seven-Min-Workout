...
class ExerciseStatusAdapter(val items: ArrayList<ExerciseModel>) :
    ...
    /**
     * {@link ViewHolder} ve RecyclerView tarafından kullanılacak bazı özel alanları başlatır.
     */
    ...
    /**
     * ArrayList'teki her öğeyi bir görünüme bağlar
     *
     * RecyclerView'ün temsil etmesi için verilen türde yeni bir {@link ViewHolder}'a ihtiyacı olduğunda çağrılır
     *
     * Bu yeni ViewHolder, öğeleri temsil edebilecek yeni bir Görünüm ile oluşturulmalıdır.
     */
